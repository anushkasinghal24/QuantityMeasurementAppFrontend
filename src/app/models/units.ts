import { UnitCategory, UnitOption } from './index';

export const UNIT_CATEGORIES: UnitCategory[] = [
  {
    id: 'length', label: 'Length', icon: '📏', color: 'from-blue-500 to-indigo-600',
    units: [
  ...
  {
    id: 'weight', label: 'Weight', icon: '⚖️', color: 'from-amber-500 to-orange-600',
    units: [
  ...
  {
    id: 'temperature', label: 'Temperature', icon: '🌡️', color: 'from-rose-500 to-pink-600',
    units: [
  ...
  {
    id: 'volume', label: 'Volume', icon: '🧪', color: 'from-teal-500 to-cyan-600',
    units: [
